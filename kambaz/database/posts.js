export default [
  // RS101 Posts
  {
    ...
    details:
      "I want to know when the midterm is, so I know when to start studying.", // required
    authorId: "123",
    answered: true,
    viewCount: 5,
  ...
  },
  {
    ...
    details:
      "One of my group members for the final project isn't responding, what should I do?",
    authorId: "456",
    answered: true,
    viewCount: 5,
    createdAt: "2026-03-31T10:00:00Z",
